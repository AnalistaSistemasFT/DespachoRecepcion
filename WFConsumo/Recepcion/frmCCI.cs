...
namespace WFConsumo
{
    public partial class frmCCI : Form
    {
        ...
        public frmCCI(Usuario u)
        {
            InitializeComponent();
           
            centrotrab = new CCentroTrabajo();
            oCC = new CAD.CADConCI();
        ...
        public void CargarRecepcion() 
        {
            ...
            DataSet data = oCC.TraerTodosCC("CLOSE",Entidades.utilitario.iSucursal);
            dataT = data.Tables[0];
        ...
        private void gridView1_RowCellClick(object sender, DevExpress.XtraGrid.Views.Grid.RowCellClickEventArgs e)
        {
            ...
            iCC = Convert.ToInt32((view.GetRowCellDisplayText(row[0], view.Columns[0])).ToString());
            ...
            DataSet dts = oCC.TraerTodosDetalleCC(iCC);
        ...
        private void tsNuevo_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //int a = oAnotacion.InsertarMovimientos(out sError, ds1, ds2, Entidades.utilitario.sUsuario, Entidades.utilitario.iSucursal, Entidades.utilitario.iAlmacen, iCC, Documento, SucOri, SucDes);
                //if(a>0)
                //{
                //    CargarRecepcion();
